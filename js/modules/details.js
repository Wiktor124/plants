...
function potColor(detail) {
	document.querySelector('#pot-image').src = detail.image;
	document.querySelector('.card-container__info-pot').textContent = detail.pot;
	document.querySelector('.card-container__info-color').textContent =
		detail.color;
}

function soil(detail) {
	document.querySelector('#soil-image').src = detail.image;
	document.querySelector('.card-container__info-soil').textContent =
		detail.soil;
}
...
function plant(detail) {
	...
	document.querySelector('.card-container__info-name').textContent =
		detail.plant;
}

function extras(details) {
	document.querySelector('#extras-container').innerHTML = details
