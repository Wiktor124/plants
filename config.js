const plantsConfig = {
	...
	peace_lily: {
		plant: 'Peace Lily',
		image:
			'https://res.cloudinary.com/diplphrxm/image/upload/v1690692070/samples/plants/plant-peace-lily_hiofo5.png',
	},
};
	...
	clay: {
		...
		purple: {
			basic: {
				pot: 'Clay simple',
				image:
					'https://res.cloudinary.com/diplphrxm/image/upload/v1692427982/samples/plants/clay-simple-purple_qemxax.png',
			},
			decorated: {
				pot: 'Clay decorated',
				image:
					'https://res.cloudinary.com/diplphrxm/image/upload/v1692427981/samples/plants/clay-decorated-purple_muvi8o.png',
			},
		},
		pink: {
			basic: {
				pot: 'Clay simple',
				image:
					'https://res.cloudinary.com/diplphrxm/image/upload/v1692427982/samples/plants/clay-simple-pink_ax38br.png',
			},
			decorated: {
				pot: 'c',
				image:
					'https://res.cloudinary.com/diplphrxm/image/upload/v1692427981/samples/plants/clay-decorated-pink_ryys5w.png',
			},
		},
		green: {
			basic: {
				pot: 'Clay simple',
				image:
					'https://res.cloudinary.com/diplphrxm/image/upload/v1692427985/samples/plants/clay-simple-green_hndtu4.png',
			},
			decorated: {
				pot: 'Clay decorated',
				image:
					'https://res.cloudinary.com/diplphrxm/image/upload/v1692427981/samples/plants/clay-decorated-green_bssmih.png',
			},
		},
		blue: {
			basic: {
				pot: 'Clay simple',
				image:
					'https://res.cloudinary.com/diplphrxm/image/upload/v1692427982/samples/plants/clay-simple-blue_vnzfdv.png',
			},
			decorated: {
				pot: 'Clay decorated',
				image:
	...
	ceramic: {
		...
		purple: {
			basic: {
				pot: 'Ceramic simple',
				image:
					'https://res.cloudinary.com/diplphrxm/image/upload/v1692427981/samples/plants/ceramic-simple-purple_niwofz.png',
			},
			decorated: {
				pot: 'Ceramic decorated',
				image:
					'https://res.cloudinary.com/diplphrxm/image/upload/v1692427984/samples/plants/ceramic-decorated-purple_ym6sum.png',
			},
		},
		pink: {
			basic: {
				pot: 'Ceramic simple',
				image:
					'https://res.cloudinary.com/diplphrxm/image/upload/v1692427983/samples/plants/ceramic-simple-pink_tprkgb.png',
			},
			decorated: {
				pot: 'Ceramic decorated',
				image:
		...
		green: {
			basic: {
				pot: 'Ceramic simple',
				image:
					'https://res.cloudinary.com/diplphrxm/image/upload/v1692427983/samples/plants/ceramic-simple-green_gzkdfg.png',
			},
			decorated: {
				pot: 'Ceramic decorated',
				image:
					'https://res.cloudinary.com/diplphrxm/image/upload/v1692427982/samples/plants/ceramic-decorated-green_kbkxcg.png',
			},
		},
		blue: {
			basic: {
				pot: 'Ceramic simple',
				image:
					'https://res.cloudinary.com/diplphrxm/image/upload/v1692427983/samples/plants/ceramic-simple-blue_loxtam.png',
			},
			decorated: {
				pot: 'Ceramic decorated',
				image:
					'https://res.cloudinary.com/diplphrxm/image/upload/v1692427983/samples/plants/ceramic-decorated-blue_a3bhas.png',
			},
		},
	},
};
...
const soilConfig = {
	composed_soil: {
		soil: 'Composed Soil',
		image:
			'https://res.cloudinary.com/diplphrxm/image/upload/v1692431156/samples/plants/soil-composted_s3w3gf.png',
	},
	premium_soli: {
		soil: 'Premium Soil',
		image:
			'https://res.cloudinary.com/diplphrxm/image/upload/v1692431156/samples/plants/soil-fertilized_bthvfn.png',
	},
	drainage_soil: {
		soil: 'Drainage Soil',
		image:
			'https://res.cloudinary.com/diplphrxm/image/upload/v1692431156/samples/plants/soil-drainage_ffxxsh.png',
	},
};
